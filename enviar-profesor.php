...
$body = "Nombre Profesor: " . $nombre ."<br>Apellidos Profesor: ". $apellidos ."<br>Colegio: " .$colegio."<br>Grado: ".$grado."<br>Correo: ".$correo."<br>Numero: ".$numero. "<br>Comentario: " .$comentario;
